...
ansible-art apply openstack_horizon inventories/openstack_horizon -p host_vars_dir/openstack_horizon_01

### Serverspec
#cd ../Serverspec
#rake -f Rakefiles/openstack_horizon spec
#RC=$?
